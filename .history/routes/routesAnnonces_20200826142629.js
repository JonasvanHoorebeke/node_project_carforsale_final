...
const usersControllersApi = require ('../controllers/usersControllersApi.js');
...
router.post('/annonce/save', annonceControllers.annonceAdd);
...
router.get('/profil/update/:iduser', usersControllers.profilUpdate);

...
exports.annonceNew = function (req, res) {
  ...
  let annonce = new Annonce(req.body.marque, req.body.modele, req.body.annee, req.body.kilometrage, req.body.prix, req.body.description, req.body.photo, req.body.codepostal);
  console.log(annonce);
